...
export default function Page({ data, author, featured_image }) {
  return (
    <Layout>
      <main className="mx-auto grid w-full max-w-page grid-cols-12 gap-6">
        <div
        ...
        >
          ...
          {!!data.tags
            ? data.tags.data.map((tag) => (
                <span
                  className="absolute left-6 top-6 z-50 rounded-full bg-white/90
        ...
        <div className="col-span-8 col-start-2 pt-4 pb-6">
          ...
          data.sections.map((section) => {
            return (
              <ReactMarkdown
                ...
                className="prose col-span-full row-start-3 w-full max-w-none
                           font-light lg:col-span-7 lg:col-start-2 pr-12"
