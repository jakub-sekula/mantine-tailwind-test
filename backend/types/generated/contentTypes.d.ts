...
export interface ApiAlbumAlbum extends Schema.CollectionType {
  ...
  attributes: {
    ...
    tags: Attribute.Relation<'api::album.album', 'manyToMany', 'api::tag.tag'>;
    show_tags: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    type: Attribute.Enumeration<['album', 'category']> &
      Attribute.Required &
      Attribute.DefaultTo<'album'>;
    category: Attribute.String & Attribute.Required;
    stick_to_top: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    ...
    albums: Attribute.Relation<
      ...
      'api::album.album'
    >;
    sections: Attribute.Component<'album.sections', true>;
    show_on_sidebar: Attribute.Boolean &
      Attribute.Required &
...
export interface ApiCvCv extends Schema.SingleType {
  ...
  attributes: {
    cv_pdf: Attribute.Media;
    sections: Attribute.Component<'cv-components.section', true>;
    seo: Attribute.Component<'shared.seo'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiHomepageHomepage extends Schema.SingleType {
  ...
  attributes: {
    about: Attribute.Component<'homepage-components.about-section'>;
    projects: Attribute.Component<'homepage-components.projects', true>;
    skills: Attribute.Component<'homepage-components.skills', true>;
    photography: Attribute.Component<'homepage-components.photography'>;
    blog: Attribute.Component<'homepage-components.blog'>;
    seo: Attribute.Component<'shared.seo'>;
    hero: Attribute.Component<'homepage-components.hero'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiPhotographyHomePhotographyHome extends Schema.SingleType {
  collectionName: 'photography_homes';
  info: {
    singularName: 'photography-home';
    pluralName: 'photography-homes';
    displayName: 'Photography home';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    albums: Attribute.Relation<
      'api::photography-home.photography-home',
      'oneToMany',
      'api::album.album'
    >;
    seo: Attribute.Component<'shared.seo'>;
...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    highlighted: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    color: Attribute.Enumeration<['red', 'green', 'blue', 'yellow']> &
      Attribute.Required &
    ...
    seo: Attribute.Component<'shared.seo'>;
    featured_image_small: Attribute.Media;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::project.project',
...
export interface ApiToolTool extends Schema.CollectionType {
  ...
  attributes: {
    ...
    show_on_homepage: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<true>;
...
declare module '@strapi/strapi' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::photography-home.photography-home': ApiPhotographyHomePhotographyHome;
