...
export async function generateMetadata() {
  ...
  return {
    title: seo?.metaTitle || "Blog - Jakub Sekula",
    description:
      seo?.metaDescription ||
      "A place for my thoughts, projects and random ramblings. Do not take too seriously.",
  };
}
  ...
  return (
    <>
      ...
      <PageWrapper title="Blog" className="max-w-5xl">
        ...
        ) : <p className="col-span-full text-center">There is nothing here yet!</p>}
      </PageWrapper>
    </>
  );
}
