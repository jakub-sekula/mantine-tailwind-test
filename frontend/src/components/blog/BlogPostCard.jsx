...
export default function BlogPostCard({ post }) {
  ...
  return (
    <Link
      ...
      className={`duration-250 hover-group rounded-card group relative col-span-full flex w-full flex-col  overflow-hidden transition-all hover:-translate-y-1 md:col-span-6 lg:col-span-4`}
    >
      {!!formats ? (
        <Image
